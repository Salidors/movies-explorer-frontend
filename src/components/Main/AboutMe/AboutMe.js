      ...
      <div className='me__private-container'>
        <div className='me__private-description-container'>
          ...
          <p className='me__private-about'>
            ...
            на "Информационные системы в экономике" вышла замуж и родила 3х
            детей. За время проведенное в декретах и между ними успела много где
            поработать и много что попробовать. В не столь далеком 2018 году мы
            с семьей переехали в Санкт-Петербург. В 2020 году появилась на свет
            младшая (4я) дочь. А вместе с ней и множество возможностей. Занялась
            саморазвитием и повышением профессиональных навыков. Всегда было
            интересно делать что-то руками и сразу видеть результат. Так я дошла
