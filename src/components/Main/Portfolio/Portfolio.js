      ...
      <nav className='portfolio__nav'>
        <ul className='portfolio__nav-list'>
          <li className='portfolio__nav-list-item'>
            <a href='https://salidors.github.io/how-to-learn/' className='link portfolio__links-item' target='_blank'>
          ...
          <li className='portfolio__nav-list-item'>
            <a href='https://salidors.github.io/russian-travel/' className='link portfolio__links-item' target='_blank'>
          ...
          <div className='line-light' />
          <li className='portfolio__nav-list-item'>
            <a href='https://salidors.github.io/mesto/' className='link portfolio__links-item' target='_blank'>
